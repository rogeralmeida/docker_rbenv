...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "Ubuntu 14.04 64bits"
  ...
  # the file Ubuntu 12.10 Quantal x86_64.pp in the manifests_path directory.
  #
  ...
  #config.vm.provision "shell", inline: $setup_containers
